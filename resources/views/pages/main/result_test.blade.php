<x-home-layout class="bg-backgroundLight text-white h-screen">
    ...
    <header class="px-24">
        <h1 class="text-3xl font-bold text-blue-dark">Hasil Rekomendasi Profesi Digital Mu</h1>
    ...
    <section class="mt-12 px-24 pb-16 grid gap-12">
        <div>
            <h2 class="text-3xl font-bold text-blue-dark mb-6">Kepribadian RIASEC Mu</h2>
        ...
        <div>
            <h2 class="text-3xl font-bold text-blue-dark mb-6">Kategori Digital Marketing</h2>
            <div class="grid grid-cols-3 gap-8">
                <div class="p-6 bg-white border-2 border-b-8 border-navy rounded-3xl cursor-pointer">
                    <h3 class="text-blue-dark text-xl font-semibold mb-2.5">Data Scientist</h3>
                    <div class="h-1.5 w-[90px] bg-orange-secondary rounded-full mb-4"></div>
    ...
    <section class="bg-white py-14 px-24">
        <h2 class="text-2xl font-bold text-blue-dark">Ingin berkonsultasi langsung ke ahlinya? Bisa!</h2>
        <p class="text-[#66696F] leading-7 mt-3">
        ...
        <div class="mt-7 flex gap-28">
            <div class="flex items-center gap-6">
                <img src="{{ asset('assets/images/pakar-1.svg') }}" alt="Pakar IT" class="border-2 border-blue-dark p-1 rounded-full" />
                <div>
                    <p class="text-xl mb-1 text-black font-bold">Angga Risky</p>
                    <p class="text-lg text-blue-dark mb-1">CEO BuildWith Angga</p>
                    <p class="text-[#66696F]">Pakar Bidang IT dan Digital</p>
                </div>
            </div>
            <div class="flex items-center gap-6">
                <img src="{{ asset('assets/images/pakar-2.svg') }}" alt="Pakar IT" class="border-2 border-blue-dark p-1 rounded-full" />
                <div>
                    <p class="text-xl mb-1 text-black font-bold">Rizky Putri</p>
                    <p class="text-lg text-blue-dark mb-1">Psikolog Talenta Indonesia</p>
                    <p class="text-[#66696F]">Pakar Bidang Psikologi</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <footer>
        <div class="flex gap-40 justify-between items-center bg-blue-dark px-24 py-[60px] h-full">
            <div>
                <h2 class="text-3xl text-white font-bold leading-10">
                    Seberapa Puas Kamu Dengan <br />
                    Hasil Ini? Berikan Pendapat Mu!
                </h2>
                <p class="text-[#E1F0FF] leading-7 mt-5 text-lg">
            ...
            <div class="grow">
                ...
                <textarea class="w-full h-32 mt-6 p-4 bg-white border-2 border-blue-dark rounded-md" placeholder="Berikan pendapatmu disini..."></textarea>
