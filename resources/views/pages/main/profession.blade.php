<x-home-layout class="bg-backgroundLight text-white h-screen">
    ...
    <header class="px-24">
        <h1 class="text-3xl font-bold text-blue-dark">Jelajahi Dunia Profesi di Bidang Digital</h1>
    ...
    <section class="mt-12 px-24 pb-24 grid gap-12">
        <div>
            <h2 class="text-3xl font-bold text-blue-dark mb-6">Kategori Data</h2>
            <div class="grid grid-cols-3 gap-8">
                <div class="p-6 bg-white border-2 border-b-8 border-navy rounded-3xl">
                    <div class="flex justify-between">
                        <h3 class="text-blue-dark text-xl font-semibold mb-2.5">Data Scientist</h3>
                        <i icon-name="info" class="w-5 ml-1 text-blue-dark"></i>
                    </div>
