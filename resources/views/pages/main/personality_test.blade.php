        ...
        <div class="relative top-12 pb-14 flex gap-7">
            <div class="grid gap-6">
                <div class="card-primary h-fit !p-8 w-[362px]">
                    ...
                    <h2 class="text-2xl font-bold text-blue-dark mb-4">Kepribadian</h2>
                ...
                <div class="card-primary h-fit !p-8 w-[362px]">
                    ...
                    <div class="grid grid-cols-5 gap-3">
                        ...
                        <div class="bg-orange-secondary rounded-md w-full text-center py-2">
            ...
            <div class="card-primary w-full h-fit !p-8">
                <form method="POST" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="flex justify-end mt-8">
                        <a href="{{ route('result_test') }}" type="button" class="button-orange w-fit">
                            Selesai
