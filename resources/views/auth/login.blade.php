    ...
    <body>
        <main class="flex justify-center items-center h-screen max-md:p-5 p-10">
            <div class="flex-col m-2">
                <div class="flex flex-col w-full gap-y-5 items-center justify-center text-white text-center max-lg:rounded-t-3xl py-8 px-10 lg:w-[500px] lg:rounded-l-3xl">
                    <img src="{{ asset('assets/images/kompas_logo.png') }}" alt="Logo Kompas" class="w-14 h-14">
